...
def _matplotlib_plot_assembly_timeline(
    quote, deadline=None, ax=None, rectangle_color="#bbbbff", scale=1.0
):
...
def plot_assembly_graph(
    quote, ax=None, margin=None, textprops=None, scale=1.0
):
